...
<body>
	<div class="cwi-head-main">
		<img src="${pageContext.request.contextPath }/resources/img/icon/logo-150.png">
		<button onclick="goto('/discover')">탐색</button>
		<c:if test="${!empty loginSession }">
			<button onclick="goto('/upload')">업로드</button>
			<button onclick="goto('/my/music')">내 페이지</button>
