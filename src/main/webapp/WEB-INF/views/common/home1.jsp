...
<img src="http://madalla.kr/script/img/a1.jpg" id="slide">
	<img src="resources/img/profile/mainBanner.jpg" class="bannerimg">
	...
	<h2>New Product List</h2>
			...
			<c:forEach var="album" items="${likeList }" varStatus="i">
				<table border="1">
						...
						<tr>
							<td colspan="2">
							<img src="resources/img/profile/like.png" width="30px;" height="30px;">
							${album.album_like }
<%-- 							<input type="button" value="공유" onclick="mainListShare(${i.index})"></td>
 --%>						</tr>
